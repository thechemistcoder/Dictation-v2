...
__all__ = [
    'ISpRecoContext2', 'DISPID_SpeechMMSysAudio', 'SRAExport',
    'SPEI_TTS_AUDIO_LEVEL', 'SPRST_INACTIVE_WITH_PURGE',
    'ISpXMLRecoResult', 'eLEXTYPE_PRIVATE19', 'SDTProperty',
    'DISPID_SpeechVoiceStatus', 'SINoSignal', 'tagSPPROPERTYINFO',
    'DISPID_SRCResume', 'SAFT8kHz8BitMono', 'SAFT24kHz16BitMono',
    'STSF_CommonAppData', 'SGDSActiveWithAutoPause',
    'DISPID_SGRsFindRule', 'SVSFIsXML', 'DISPID_SRCEInterference',
    'SDTAll', 'DISPID_SGRSTPropertyValue', 'DISPID_SOTsItem',
    'SpeechDisplayAttributes', 'SPWORDTYPE',
    'DISPID_SpeechObjectToken', 'DISPID_SOTCategory',
    '_RemotableHandle', 'SPSSuppressWord', 'SpUnCompressedLexicon',
    'SPFM_OPEN_READONLY', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SPPParent', 'SPXRO_Alternates_SML', 'SDTRule',
    'DISPID_SRCSetAdaptationData', 'eLEXTYPE_RESERVED9',
    'DISPID_SpeechRecoResult', 'eLEXTYPE_PRIVATE6',
    'DISPID_SpeechAudioFormat', 'SAFTADPCM_11kHzMono',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SVRate', 'SGRSTTDictation',
    'DISPID_SpeechPhraseBuilder', 'ISpeechObjectTokens',
    'DISPID_SLWs_NewEnum', 'SVP_17',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpeechObjectToken',
    'DISPID_SDKGetStringValue', 'SAFTCCITT_uLaw_11kHzMono',
    'SSTTTextBuffer', 'ISpAudio', 'DISPID_SPIProperties',
    'ISpeechAudioBufferInfo', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SGRsCommit', 'SDTAudio', 'SVSFUnusedFlags',
    'SpeechEmulationCompareFlags', 'DISPIDSPTSI_SelectionLength',
    'SAFT32kHz8BitMono', 'SpeechStreamSeekPositionType',
    'DISPID_SDKSetLongValue', 'DISPID_SVSpeak',
    'DISPID_SPILanguageId', 'SGDisplay',
    'SpeechSpecialTransitionType', 'DISPID_SLWWord',
    'SpeechEngineConfidence', 'DISPID_SWFEBlockAlign',
    'DISPID_SPPValue',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPEI_RESERVED3', 'DISPID_SGRsItem',
    'DISPID_SPRDisplayAttributes', 'SREAdaptation', 'SVEAudioLevel',
    'DISPID_SVVolume', 'DISPID_SpeechLexiconPronunciation', 'SPRULE',
    'DISPID_SpeechRecoResultTimes', 'SPSEMANTICERRORINFO',
    'eLEXTYPE_PRIVATE5', 'DISPID_SDKSetStringValue', 'SASRun',
    'DISPID_SLPsCount', 'DISPID_SDKDeleteKey', 'DISPID_SBSSeek',
    'SPAUDIOBUFFERINFO', 'SPRS_ACTIVE', 'SVSFDefault', 'SGRSTTWord',
    'DISPID_SASCurrentSeekPosition',
    'SpeechGrammarRuleStateTransitionType', 'eWORDTYPE_DELETED',
    'DISPID_SRDisplayUI', 'SP_VISEME_0', 'SRESoundEnd',
    'SpeechVoiceSkipTypeSentence', 'SVF_None',
    'SSSPTRelativeToCurrentPosition', 'ISpeechLexiconWord',
    'DISPID_SRRAudio', 'DISPID_SRRSaveToMemory', 'SRARoot',
    'SPSMF_UPS', 'SPFM_OPEN_READWRITE', 'SREBookmark', 'SVEPhoneme',
    'SpeechRecoEvents', 'DISPID_SOTIsUISupported', 'SPLO_DYNAMIC',
    'SDTAlternates', 'SAFT11kHz8BitStereo', 'SpStream',
    'DISPID_SRGCommit', 'SPSERIALIZEDPHRASE', 'SpeechVisemeType',
    'SDA_One_Trailing_Space', 'DISPID_SpeechGrammarRule', 'SVPNormal',
    'DISPID_SGRAddState', 'ISpeechBaseStream',
    'SPINTERFERENCE_TOOLOUD', 'SDA_No_Trailing_Space',
    'Speech_Max_Pron_Length', 'SRERecoOtherContext',
    'DISPID_SVSLastBookmark', 'DISPID_SWFEAvgBytesPerSec',
    'STCLocalServer', 'DISPID_SRCERecognitionForOtherContext',
    'SPEI_MIN_TTS', 'DISPID_SPEDisplayText',
    'DISPID_SVSyncronousSpeakTimeout', 'ISpPhoneticAlphabetSelection',
    'DISPID_SGRSTsItem', 'SDKLCurrentConfig', 'SVP_1',
    'SAFT16kHz8BitMono', 'SPPHRASEPROPERTY',
    'SAFTExtendedAudioFormat', 'SPSHORTCUTPAIRLIST', 'SREStreamEnd',
    'eLEXTYPE_PRIVATE8', 'SPVPRI_ALERT', 'SpeechTokenKeyUI',
    'DISPID_SRCreateRecoContext', 'DISPID_SPPConfidence',
    'SAFTADPCM_44kHzMono', 'SVSFNLPSpeakPunc', 'DISPID_SGRsCount',
    'DISPID_SGRSAddWordTransition', 'DISPID_SRCEPhraseStart',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SpeechGrammarRuleState', 'SPEI_START_INPUT_STREAM',
    'DISPID_SPRuleParent', 'SITooFast', 'DISPID_SRGCmdLoadFromFile',
    'SpeechLoadOption', 'DISPID_SPRulesCount', 'SpeechDiscardType',
    'SPDKL_CurrentUser', 'eLEXTYPE_PRIVATE3',
    'SpeechGrammarTagWildcard', 'SpLexicon', 'DISPID_SPIRule',
    'ISpeechRecognizer', 'SpeechRetainedAudioOptions', 'SRTAutopause',
    'Speech_StreamPos_Asap', 'SPPS_Noun', 'DISPID_SGRs_NewEnum',
    'SVP_15', 'DISPID_SPRuleChildren',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SRRAudioFormat',
    'ISpShortcut', 'SAFT12kHz16BitMono', 'SAFTADPCM_8kHzStereo',
    'SITooQuiet', 'IEnumSpObjectTokens', 'SAFT44kHz16BitMono',
    'DISPID_SPRuleName', 'SDTPronunciation', 'DISPID_SRCEEndStream',
    'SPCT_COMMAND', 'SPEVENTENUM', 'DISPID_SLGetPronunciations',
    'DISPID_SpeechLexicon', 'SPEI_INTERFERENCE', 'ISpGrammarBuilder',
    'SpeechFormatType', 'SSFMCreate', 'eLEXTYPE_RESERVED7',
    'SPAS_PAUSE', 'SPEI_WORD_BOUNDARY', 'SpMemoryStream', 'SVP_5',
    'SPSHORTCUTPAIR', 'DISPID_SDKOpenKey', 'DISPID_SLGetWords',
    'SECHighConfidence', 'DISPID_SAFType', 'ISpeechPhraseRules',
    'DISPID_SLRemovePronunciationByPhoneIds', 'ISpeechPhraseProperty',
    'DISPID_SABIMinNotification', 'DISPID_SPCIdToPhone',
    'DISPID_SVEWord', 'ISpeechPhraseReplacements',
    'DISPID_SGRSTWeight', 'SLTUser', 'SAFTCCITT_uLaw_44kHzStereo',
    'eLEXTYPE_PRIVATE15', 'SREPhraseStart', 'SASPause',
    'SpeechPropertyComplexResponseSpeed',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SAFGuid',
    'SpeechRegistryLocalMachineRoot', 'eLEXTYPE_PRIVATE10',
    'DISPID_SVVoice', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SpeechPhraseReplacement', 'SpNullPhoneConverter',
    'DISPID_SVSInputWordPosition', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SVSInputWordLength', 'DISPID_SPRs_NewEnum',
    'SPEI_TTS_PRIVATE', 'DISPID_SRCVoice', 'ISpeechLexicon',
    'DISPID_SpeechAudioBufferInfo',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SVEBookmark',
    'DISPID_SPIReplacements', 'DISPID_SpeechPhraseElement',
    'SpPhraseInfoBuilder', 'SpeechTokenValueCLSID',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SADefaultFormat',
    'DISPID_SOTDataKey', 'DISPID_SVGetAudioOutputs',
    'DISPID_SABufferInfo', 'DISPID_SPRNumberOfElements',
    'SP_VISEME_19', 'SP_VISEME_18', 'DISPID_SLPSymbolic',
    'SPRST_ACTIVE', 'SAFTCCITT_uLaw_8kHzMono',
    'SPEI_RECO_STATE_CHANGE', 'DISPIDSPTSI_ActiveOffset', 'SVP_11',
    'ISpVoice', 'DISPID_SGRSRule', 'SPSMF_SAPI_PROPERTIES',
    'ISpeechTextSelectionInformation', 'SRSInactiveWithPurge',
    'DISPID_SPEAudioSizeBytes', 'SPEI_SR_AUDIO_LEVEL',
    'SPCT_SUB_DICTATION', 'DISPID_SRCEPropertyNumberChange',
    'UINT_PTR', 'SVEBookmark', 'SPTEXTSELECTIONINFO',
    'SDTReplacement', 'SSSPTRelativeToEnd',
    'SAFTCCITT_ALaw_11kHzMono', 'SVEWordBoundary',
    'SPWORDPRONOUNCEABLE', 'SpInProcRecoContext', 'SVF_Emphasis',
    'DISPID_SVSLastBookmarkId', 'DISPID_SAStatus', 'SP_VISEME_6',
    'ISpDataKey', 'SpMMAudioIn', 'ISpObjectToken',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SVSkip',
    'SpCustomStream', 'SAFT24kHz8BitMono',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPEI_HYPOTHESIS',
    'ISpResourceManager', 'DISPID_SPIAudioStreamPosition',
    'SpeechDataKeyLocation', 'SPRST_INACTIVE',
    'ISpStreamFormatConverter', 'SAFT22kHz8BitMono',
    'DISPID_SVSInputSentenceLength', 'SPINTERFERENCE_LATENCY_WARNING',
    'SPRECORESULTTIMES', 'SPEI_MAX_TTS', 'SREPrivate',
    'ISpObjectWithToken', 'DISPID_SRGIsPronounceable',
    'DISPID_SOTMatchesAttributes', 'SAFTCCITT_uLaw_8kHzStereo',
    'SpeechStreamFileMode', 'DISPID_SDKEnumKeys',
    'SAFTCCITT_ALaw_44kHzMono', '_SPAUDIOSTATE',
    'DISPID_SPRFirstElement', 'DISPID_SRCRecognizer',
    'SPPS_RESERVED4', 'SVF_Stressed', 'SVESentenceBoundary',
    'SPAUDIOSTATUS', 'DISPID_SGRAttributes', 'SpeechTokenShellFolder',
    'DISPID_SpeechAudio', 'SpeechBookmarkOptions',
    'SpeechCategoryAudioOut', 'DISPID_SRRTOffsetFromStart',
    'SAFT8kHz16BitMono', 'SGSEnabled', 'IInternetSecurityMgrSite',
    'eLEXTYPE_PRIVATE17', 'SAFT32kHz16BitMono', 'SPAR_High',
    'DISPID_SRGDictationLoad', 'DISPID_SPCLangId',
    'SAFT11kHz16BitMono', 'eLEXTYPE_RESERVED8', 'SGDSInactive',
    'DISPID_SRRGetXMLErrorInfo', 'SpeechGrammarState',
    'DISPID_SVDisplayUI', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SVEStreamEnd', 'SFTSREngine', 'ISpeechAudioFormat',
    'SPFM_NUM_MODES', 'DISPID_SRSetPropertyString', 'SP_VISEME_20',
    'SRAInterpreter', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SVAudioOutputStream', 'DISPID_SOTCSetId', 'ISpStream',
    'SpSharedRecognizer', 'SpeechTokenKeyAttributes',
    'DISPID_SPRuleEngineConfidence', 'SVEVoiceChange',
    'SpeechAddRemoveWord', 'DISPID_SOTGetStorageFileName',
    'SECFIgnoreKanaType', 'SPPS_Interjection', 'SPBINARYGRAMMAR',
    'DISPID_SLPs_NewEnum', 'DISPID_SRGetPropertyNumber',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SLWLangId',
    'DISPID_SDKGetlongValue', 'SPEI_START_SR_STREAM',
    'DISPID_SPAs_NewEnum', 'SREPropertyStringChange',
    'SpeechRecoContextState', 'eLEXTYPE_PRIVATE14', 'STSF_AppData',
    'SVSFParseMask', 'DISPID_SGRSTType', 'SAFTCCITT_ALaw_44kHzStereo',
    'SpeechGrammarTagDictation', 'eLEXTYPE_PRIVATE4',
    'eLEXTYPE_RESERVED6', 'DISPID_SPEActualConfidence', 'SLOStatic',
    'DISPID_SMSGetData', 'DISPID_SGRName',
    'SpeechPropertyNormalConfidenceThreshold',
    'SDA_Consume_Leading_Spaces', 'DISPID_SpeechPhoneConverter',
    'SRTEmulated', 'eLEXTYPE_PRIVATE18', 'SPLOADOPTIONS',
    'DISPID_SPRuleFirstElement', 'SGRSTTRule', 'SPPS_NotOverriden',
    'SPSNotOverriden', 'DISPIDSPRG', 'DISPID_SRCCreateGrammar',
    'DISPID_SGRSTPropertyId', 'DISPID_SPPNumberOfElements',
    'SECFDefault', 'DISPID_SpeechPhraseAlternates', 'SVSFParseSapi',
    'DISPID_SVAlertBoundary', 'DISPID_SPAsItem',
    'DISPID_SRCESoundStart', 'SPWAVEFORMATTYPE', 'SP_VISEME_17',
    'SPPROPERTYINFO', 'SVP_7', 'DISPID_SRAudioInput',
    'DISPID_SLPType', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SVEPhoneme', 'DISPID_SRCEAdaptation',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'eLEXTYPE_PRIVATE2',
    'DISPID_SAVolume', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRCRetainedAudio', 'DISPID_SGRsAdd', 'DISPID_SBSRead',
    'SpeechCategoryPhoneConverters', 'SPPS_SuppressWord',
    'SPRS_ACTIVE_USER_DELIMITED', 'SBOPause',
    'DISPID_SRCCmdMaxAlternates', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRCEEnginePrivate', 'eWORDTYPE_ADDED',
    'DISPID_SASNonBlockingIO', 'DISPID_SOTGetDescription',
    'SVSFPurgeBeforeSpeak', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPEI_SR_BOOKMARK',
    'SpObjectTokenCategory', 'DISPID_SBSFormat', 'DISPID_SOTCId',
    'SPDKL_LocalMachine', 'DISPID_SRStatus', 'DISPID_SRCEBookmark',
    'SAFT11kHz8BitMono', 'DISPID_SPRuleId', 'SECFNoSpecialChars',
    'ISpeechRecoContext', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SPEsCount', 'ISpeechLexiconPronunciation',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SRGSetTextSelection',
    'SVP_3', 'ISpeechPhoneConverter', 'DISPID_SVEViseme',
    'ISpeechGrammarRuleStateTransition', 'SPPS_Verb', 'SpMMAudioOut',
    'SPAO_RETAIN_AUDIO', 'ISpNotifySink', 'ISequentialStream',
    'ISpeechGrammarRules', 'SpeechCategoryRecognizers',
    'DISPID_SpeechPhraseInfo', 'SPPS_Unknown',
    'DISPID_SVEStreamStart', 'SpFileStream', 'DISPID_SRCERequestUI',
    'DISPID_SPANumberOfElementsInResult', 'SREStateChange',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'eLEXTYPE_MORPHOLOGY',
    'SAFT8kHz8BitStereo', 'eLEXTYPE_PRIVATE20', 'DISPID_SOTCDefault',
    'SAFT11kHz16BitStereo', 'DISPID_SpeechMemoryStream',
    'SpeechCategoryAudioIn', 'SPFM_CREATE_ALWAYS',
    'SPEI_END_SR_STREAM', 'SPSHT_NotOverriden',
    'ISpeechPhraseElements', 'DISPID_SPPEngineConfidence',
    'ISpeechRecognizerStatus', 'SAFTText', 'SVSFlagsAsync',
    'SAFTADPCM_22kHzMono', 'SPEI_RESERVED1', 'SP_VISEME_16',
    'IInternetSecurityManager', 'DISPID_SVGetVoices',
    'DISPID_SRCEStartStream', 'DISPID_SGRsCommitAndSave',
    'ISpeechResourceLoader', 'SRERecognition', 'SRAONone',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPAS_RUN',
    'SRCS_Disabled', 'SPAR_Low', 'DISPID_SVSpeakCompleteEvent',
    'SAFTADPCM_11kHzStereo', 'DISPID_SWFEBitsPerSample',
    'SPSERIALIZEDRESULT', 'DISPID_SRCPause', 'SSFMOpenForRead',
    'SpeechUserTraining', 'DISPID_SRGetRecognizers', 'DISPID_SPRText',
    'SPCT_SLEEP', 'SWPUnknownWordUnpronounceable', 'SP_VISEME_13',
    'STCInprocServer', 'SPGS_EXCLUSIVE', 'SPPHRASEREPLACEMENT',
    'eLEXTYPE_APP', 'DISPID_SpeechObjectTokens', 'SPSNoun',
    'DISPID_SGRId', 'SVEAllEvents', 'SpeechWordPronounceable',
    'SECFIgnoreWidth', 'SVP_20', 'SRESoundStart', 'STCRemoteServer',
    'SPXRO_SML', 'DISPID_SpeechPhraseRule', 'SPGS_DISABLED',
    'DISPID_SMSSetData', 'SRTSMLTimeout', '_ISpeechVoiceEvents',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SPIAudioSizeBytes',
    'ISpeechPhraseInfo', 'ISpeechAudioStatus', 'SpeechInterference',
    'DISPID_SREmulateRecognition', 'SPRST_ACTIVE_ALWAYS',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SpeechPhraseProperties', 'SPSModifier',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SRRTTickCount',
    'SpeechWordType', 'DISPID_SRGetFormat', 'SPEI_TTS_BOOKMARK',
    'DISPID_SAEventHandle', 'SpResourceManager',
    'DISPID_SPEAudioSizeTime', 'DISPID_SpeechLexiconProns',
    'DISPID_SPIElements', 'SpeechDictationTopicSpelling',
    'SpeechRecognitionType', 'SREInterference', 'DISPID_SRGRules',
    'SVP_9', 'SRADefaultToActive', 'SAFT16kHz16BitMono',
    'SpAudioFormat', 'SECNormalConfidence', 'SREAllEvents',
    'SREFalseRecognition', 'SpeechAudioFormatGUIDWave',
    'SPEI_SOUND_START', 'SPCT_SUB_COMMAND', 'SP_VISEME_9',
    'DISPID_SLPLangId', 'SVEEndInputStream', 'DISPID_SRProfile',
    'SP_VISEME_15', 'SREStreamStart', 'SAFT8kHz16BitStereo',
    'ISpeechObjectTokenCategory', 'DISPID_SPAsCount',
    'DISPID_SPERetainedStreamOffset', 'SPCS_ENABLED',
    'DISPID_SRSAudioStatus', 'SDKLLocalMachine',
    'SWPUnknownWordPronounceable', 'SVP_12', 'SAFT12kHz16BitStereo',
    'Speech_Default_Weight', 'SAFT44kHz8BitMono', 'SPEI_SOUND_END',
    'ISpNotifyTranslator', 'DISPID_SLGenerationId', 'SPAR_Unknown',
    'SRSActive', 'DISPID_SVSLastResult', 'SPBO_NONE',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SPIEnginePrivateData',
    'SRSInactive', 'SpShortcut', 'ISpeechPhraseProperties',
    'SPEI_PHONEME', 'SAFTADPCM_8kHzMono', 'DISPID_SpeechDataKey',
    'SpeechAllElements', 'SpeechCategoryVoices',
    'SpeechPropertyResourceUsage', 'DISPID_SLWPronunciations',
    'SPVPRI_OVER', 'DISPID_SPARecoResult',
    'SpeechAudioFormatGUIDText', 'DISPID_SDKEnumValues',
    'SPDKL_CurrentConfig', 'SVSFVoiceMask', 'SPAR_Medium',
    'DISPID_SRGCmdSetRuleIdState', 'SRATopLevel', 'SVEViseme',
    'DISPID_SPISaveToMemory', 'SPSHT_EMAIL', 'SRADynamic',
    'DISPID_SWFEExtraData', 'SPBO_AHEAD', 'DISPID_SpeechCustomStream',
    'SPEI_ADAPTATION', 'eLEXTYPE_PRIVATE11',
    'SpeechRecoProfileProperties', 'DISPID_SPRules_NewEnum',
    'DISPID_SRCEAudioLevel', 'SAFT24kHz16BitStereo',
    'eLEXTYPE_PRIVATE9', 'SpNotifyTranslator', 'SPPARTOFSPEECH',
    'SVP_21', 'DISPID_SLWsCount', 'SP_VISEME_5', 'DISPID_SRCBookmark',
    'DISPID_SOTsCount', 'SLODynamic', 'ISpeechPhraseRule',
    'ISpLexicon', 'DISPID_SPERetainedSizeBytes', 'ISpRecoResult',
    'DISPID_SVEventInterests', 'SPRECOSTATE', 'ISpeechRecoGrammar',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SRRRecoContext',
    '_ISpeechRecoContextEvents', 'SGPronounciation', 'SP_VISEME_1',
    'DISPID_SOTCGetDataKey', 'SPLO_STATIC', 'ISpMMSysAudio',
    'SGSDisabled', 'DISPID_SPIStartTime', 'SpObjectToken',
    'SVSFIsNotXML', 'DISPID_SpeechObjectTokenCategory', 'SPPHRASE',
    'SPFM_CREATE', 'SVSFParseAutodetect', 'ISpStreamFormat',
    'DISPID_SPEEngineConfidence', 'DISPID_SVPause',
    'SpeechVisemeFeature', 'IEnumString', 'ISpeechPhraseAlternates',
    'ISpeechLexiconPronunciations', 'SVP_18', 'SP_VISEME_2',
    'SPPHRASEELEMENT', 'SFTInput', 'DISPID_SWFESamplesPerSec',
    'SPCATEGORYTYPE', 'SP_VISEME_8', 'ISpeechVoiceStatus',
    'ISpRecoGrammar', 'SAFTNoAssignedFormat', 'DISPID_SOTDisplayUI',
    'DISPID_SPELexicalForm', 'DISPID_SFSClose',
    'DISPID_SRGRecoContext', 'DISPID_SpeechRecoContextEvents',
    'SpVoice', 'SP_VISEME_4', 'SVP_13', 'SP_VISEME_11',
    'WAVEFORMATEX', 'DISPID_SpeechLexiconWord', 'DISPID_SPACommit',
    'SpeechVoiceEvents', 'SVEStartInputStream', 'SPPS_RESERVED1',
    'SPSHT_OTHER', 'SPEI_RESERVED6', 'SPSTREAMFORMATTYPE',
    'SPINTERFERENCE_TOOQUIET', 'SPEI_PHRASE_START', 'DISPIDSPTSI',
    'DISPID_SPIAudioSizeTime', 'eLEXTYPE_PRIVATE13', 'SPPS_RESERVED2',
    'ISpRecognizer3', 'DISPID_SOTId', 'SpeechVoicePriority',
    'ISpeechLexiconWords', 'DISPID_SASFreeBufferSpace',
    'SPINTERFERENCE_TOOFAST', 'SAFT12kHz8BitStereo',
    'DISPID_SRRPhraseInfo', 'DISPID_SpeechXMLRecoResult',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SLWType', 'SPPS_Noncontent',
    'SVP_6', 'ISpNotifySource', 'SPEI_VOICE_CHANGE',
    'DISPID_SVGetAudioInputs', 'DISPID_SLAddPronunciationByPhoneIds',
    'IStream', 'SAFT48kHz8BitStereo', 'SDTLexicalForm',
    'SSTTDictation', 'DISPID_SRAudioInputStream', 'SPSHORTCUTTYPE',
    'SPEI_SENTENCE_BOUNDARY', 'SPEI_VISEME', 'DISPID_SBSWrite',
    'DISPID_SRCCreateResultFromMemory', 'ISpSerializeState',
    'eLEXTYPE_PRIVATE1', 'SVP_14', 'SPEI_SR_PRIVATE', 'SPEI_MAX_SR',
    'SpeechVoiceSpeakFlags', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SPAStartElementInResult', 'SAFTCCITT_uLaw_22kHzStereo',
    'SECFIgnoreCase', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SPRsItem', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'STCInprocHandler', 'SSFMCreateForWrite', 'SAFTGSM610_11kHzMono',
    'ISpRecoContext', 'SDKLDefaultLocation', 'SPLEXICONTYPE',
    'DISPID_SCSBaseStream', 'SDTDisplayText', 'SpeechTokenContext',
    'SpeechCategoryAppLexicons', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRGDictationSetState', 'SPVISEMES',
    'DISPID_SPIGetDisplayAttributes', 'SPEI_RESERVED5',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SVIsUISupported',
    'SREHypothesis', 'SpTextSelectionInformation', 'SPSUnknown',
    'SPGRAMMARWORDTYPE', 'SPINTERFERENCE_NOISE',
    'DISPID_SpeechPhraseElements', 'DISPID_SOTGetAttribute',
    'DISPID_SASState', 'DISPID_SRCRetainedAudioFormat', 'SWTAdded',
    'DISPID_SPEsItem', 'SPEI_RECOGNITION', 'SWTDeleted',
    'SpeechTokenKeyFiles', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SOTs_NewEnum', 'SPEI_MIN_SR', 'DISPID_SPPs_NewEnum',
    'ISpRecoGrammar2', 'DISPID_SPPId', 'DISPID_SMSAMMHandle',
    'SPCONTEXTSTATE', 'SPINTERFERENCE_NONE', 'SVPAlert',
    'DISPID_SRState', 'SP_VISEME_21', 'SPPS_Function',
    'SpeechGrammarTagUnlimitedDictation', 'SpeechMicTraining',
    'DISPID_SRCESoundEnd', 'DISPID_SGRClear', 'SVP_19',
    'DISPID_SMSALineId', 'SLTApp', 'DISPID_SDKSetBinaryValue',
    'DISPIDSPTSI_SelectionOffset', 'eLEXTYPE_USER', 'SPSLMA',
    'DISPID_SRGCmdLoadFromObject', 'ISpObjectTokenCategory',
    'SPAO_NONE', 'SpCompressedLexicon', 'DISPID_SRIsUISupported',
    'SPRST_NUM_STATES', 'DISPID_SFSOpen', 'SPWF_SRENGINE',
    'SPEI_REQUEST_UI', 'DISPID_SRCState', 'DISPID_SPPFirstElement',
    'eLEXTYPE_RESERVED4', 'ISpEventSource', 'SAFT32kHz8BitStereo',
    'DISPID_SpeechLexiconWords', 'ISpeechRecoResultDispatch',
    'ISpPhraseAlt', 'SPINTERFERENCE_NOSIGNAL', 'SPBO_TIME_UNITS',
    '__MIDL_IWinTypes_0009', 'DISPID_SAFGetWaveFormatEx',
    'SpSharedRecoContext', 'DISPID_SRSNumberOfActiveRules',
    'ISpPhoneConverter', 'SPSFunction', 'SAFTADPCM_44kHzStereo',
    'DISPID_SDKGetBinaryValue', 'SpeechEngineProperties',
    'SPEI_END_INPUT_STREAM', 'SAFT44kHz8BitStereo',
    'SAFTTrueSpeech_8kHz1BitMono',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SVEEnginePrivate',
    'STCAll', 'SpeechPropertyHighConfidenceThreshold',
    'SpWaveFormatEx', 'SVSFNLPMask', 'DISPID_SGRSTPropertyName',
    'SPAS_STOP', 'SP_VISEME_3', 'SpeechLexiconType',
    'DISPID_SpeechPhraseAlternate', 'SASClosed', 'SBONone',
    'eLEXTYPE_USER_SHORTCUT', 'SPSEMANTICFORMAT',
    'ISpeechRecoResult2', 'SAFTGSM610_22kHzMono',
    'SPWT_PRONUNCIATION', 'SPVOICESTATUS', 'DISPID_SpeechRecoContext',
    'SGDSActiveUserDelimited', 'SREAudioLevel', 'SAFT12kHz8BitMono',
    'SRSEDone', 'SAFT16kHz16BitStereo', 'SPAUDIOSTATE',
    'SAFTGSM610_8kHzMono', 'SPRS_INACTIVE', 'SpeechAudioProperties',
    'SPEI_SR_RETAINEDAUDIO', 'STSF_LocalAppData', 'ISpEventSink',
    'DISPID_SASetState', 'DISPID_SpeechFileStream', 'SVP_16',
    'SpeechPartOfSpeech', 'DISPID_SRRSpeakAudio',
    'DISPID_SVEAudioLevel', 'DISPID_SRRTimes', 'SRSEIsSpeaking',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SPERequiredConfidence',
    'SSTTWildcard', 'SGRSTTTextBuffer', 'ISpRecoCategory',
    'DISPID_SRGCmdLoadFromMemory', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SGRSAddRuleTransition', 'STSF_FlagCreate',
    'DISPID_SPRsCount', 'ISpeechGrammarRuleStateTransitions',
    'ISpeechMMSysAudio', 'SPWT_LEXICAL', 'tagSTATSTG',
    'eLEXTYPE_RESERVED10', 'DISPID_SGRInitialState',
    'DISPID_SpeechGrammarRules', 'SVSFParseSsml', 'SPEI_UNDEFINED',
    'SP_VISEME_10', 'SECLowConfidence', 'SASStop', 'ISpeechDataKey',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SABIBufferSize',
    'SRCS_Enabled', 'DISPID_SPEs_NewEnum', 'SGRSTTEpsilon',
    'SPEI_PROPERTY_STRING_CHANGE', 'SAFT32kHz16BitStereo',
    'SDKLCurrentUser', 'SVSFIsFilename', 'DISPID_SpeechBaseStream',
    'DISPID_SVSRunningState', 'DISPID_SRGDictationUnload',
    'DISPID_SGRSTransitions', 'DISPID_SDKDeleteValue',
    'DISPID_SVSCurrentStreamNumber', 'SPSInterjection',
    'DISPIDSPTSI_ActiveLength', 'SPGRAMMARSTATE', 'SP_VISEME_12',
    'DISPID_SRRAlternates', 'DISPID_SPIGetText',
    'DISPID_SPRuleConfidence', 'SPRECOCONTEXTSTATUS', 'SITooSlow',
    'DISPID_SPPsItem', 'ISpProperties', 'ISpeechXMLRecoResult',
    'SpeechRecognizerState', 'DISPID_SVSPhonemeId', 'ISpeechVoice',
    'SPINTERFERENCE', 'DISPID_SPCPhoneToId', 'DISPID_SVPriority',
    'DISPID_SRGSetWordSequenceData',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SRSSupportedLanguages', 'SGLexicalNoSpecialChars',
    'SAFT24kHz8BitStereo', 'DISPID_SLGetGenerationChange',
    'DISPID_SVStatus', 'SRERequestUI', 'DISPID_SPPsCount',
    'SPDATAKEYLOCATION', 'DISPID_SRCERecognition', 'DISPID_SRGId',
    'SpeechAudioFormatType', 'DISPID_SAFSetWaveFormatEx',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SOTCreateInstance',
    'DISPID_SRCEventInterests', 'DISPID_SRCEHypothesis',
    'SVSFPersistXML', 'SpInprocRecognizer',
    'DISPID_SVSInputSentencePosition',
    'DISPID_SRSCurrentStreamPosition', 'ISpPhoneticAlphabetConverter',
    'SWPKnownWordPronounceable', 'ISpeechMemoryStream', 'SPWORDLIST',
    'SAFT48kHz16BitMono', 'eLEXTYPE_PRIVATE7', 'DISPID_SPAPhraseInfo',
    'DISPID_SVSLastStreamNumberQueued', 'SAFT22kHz16BitStereo',
    'DISPID_SPIEngineId', 'DISPID_SpeechPhraseReplacements',
    'SPSHT_Unknown', 'SpeechTokenIdUserLexicon', 'SPEI_RESERVED2',
    'SAFTNonStandardFormat', 'SSFMOpenReadWrite', 'SECFEmulateResult',
    'DISPID_SGRSTText', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SRRTLength', 'ISpeechPhraseAlternate',
    'DISPID_SRCEFalseRecognition', 'ISpeechGrammarRule',
    'SAFT48kHz16BitStereo', 'DISPID_SRRGetXMLResult',
    'SpeechAudioVolume', 'DISPID_SLWsItem',
    'DISPID_SpeechAudioStatus', 'DISPID_SOTSetId', 'SVP_0',
    'DISPID_SRGetPropertyString', 'SPWORDPRONUNCIATION',
    'SAFTADPCM_22kHzStereo', 'DISPID_SPIGrammarId',
    'DISPID_SRRecognizer', 'SRTExtendableParse', 'ISpRecognizer',
    'DISPID_SGRSTNextState', 'DISPID_SWFEFormatTag',
    'DISPID_SOTRemove', 'SITooLoud', 'SpeechAudioState',
    'ISpeechPhraseElement', 'DISPID_SWFEChannels',
    'DISPID_SpeechVoice', 'DISPID_SPEAudioStreamOffset',
    'SpeechRuleAttributes', 'SAFT48kHz8BitMono', 'ISpeechRecoResult',
    'DISPID_SLPsItem', 'SPDKL_DefaultLocation', 'SPSVerb',
    'Speech_StreamPos_RealTime', 'SVP_10', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SRCRequestedUIType', 'DISPID_SVSVisemeId',
    'DISPID_SGRSTsCount', 'SVEPrivate', 'SPAUDIOOPTIONS', 'LONG_PTR',
    'DISPID_SLPPartOfSpeech', 'DISPID_SRIsShared', 'SP_VISEME_14',
    'SPVPRI_NORMAL', 'SPWT_DISPLAY', 'SpPhoneConverter',
    'ISpeechCustomStream', 'SPXMLRESULTOPTIONS',
    'DISPID_SVWaitUntilDone', 'SPVPRIORITY', 'SAFT16kHz8BitStereo',
    'SPRECOGNIZERSTATUS', 'DISPID_SpeechPhraseRules',
    'DISPID_SLRemovePronunciation', 'DISPID_SLAddPronunciation',
    'SPADAPTATIONRELEVANCE', 'SPPS_LMA', 'SREPropertyNumChange',
    'SpeechRuleState', 'SGSExclusive', 'DISPID_SVResume',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPRULESTATE', 'SPWORD',
    'ISpeechGrammarRuleState', 'DISPID_SpeechRecoResult2',
    'DISPID_SRSClsidEngine', 'SPGS_ENABLED', 'SPEVENTSOURCEINFO',
    'DISPID_SRGReset', 'SpeechCategoryRecoProfiles',
    'SpeechPropertyAdaptationOn', 'DISPID_SGRSTRule',
    'eLEXTYPE_PRIVATE16', 'DISPID_SGRAddResource', 'ISpPhrase',
    'SRAImport', 'DISPID_SPRulesItem', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'eLEXTYPE_PRIVATE12', 'SVP_8', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SVESentenceBoundary', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SGRSTs_NewEnum', 'ISpeechFileStream',
    'SpStreamFormatConverter', 'DISPID_SPPChildren',
    'DISPID_SPEDisplayAttributes', 'SVPOver', 'DISPID_SLPPhoneIds',
    'SGDSActive', 'SAFTGSM610_44kHzMono', 'ISpRecognizer2',
    'SPFILEMODE', 'SPBOOKMARKOPTIONS', 'SRTReSent',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SVGetProfiles', 'SGLexical',
    'SPPS_Modifier', 'DISPID_SpeechPhraseProperty', 'SRAORetainAudio',
    'ISpeechPhraseReplacement', 'DISPID_SABufferNotifySize',
    'SRSActiveAlways', 'DISPID_SABIEventBias', 'DISPID_SVAudioOutput',
    'SRTStandard', 'DISPID_SPEPronunciation', 'SSSPTRelativeToStart',
    'SPWF_INPUT', 'SPCS_DISABLED', 'SPCT_DICTATION', 'SP_VISEME_7',
    'DISPID_SpeechWaveFormatEx', 'SVP_2', 'SpeechRunState', 'SVP_4',
    'DISPID_SRGState', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRSetPropertyNumber',
    'SPEVENT', 'DISPID_SPPName', 'DISPID_SMSADeviceId',
    'DISPID_SVSpeakStream', 'DISPID_SpeechVoiceEvent', 'ISpeechAudio',
    'DISPID_SRRTStreamTime', 'Speech_Max_Word_Length',
    'SAFT22kHz16BitMono', 'SPBO_PAUSE', 'SPPS_RESERVED3',
    'DISPID_SpeechRecognizer', 'DISPID_SRRSetTextFeedback',
    'SAFT44kHz16BitStereo', 'SINoise', 'SpeechGrammarWordType',
    'SPPHRASERULE', 'SAFT22kHz8BitStereo', 'SPAS_CLOSED',
    'SGRSTTWildcard', 'SAFTDefault', 'DISPID_SVEVoiceChange',
    'ISpeechRecoResultTimes', 'SpMMAudioEnum', 'ISpeechWaveFormatEx',
    'SDA_Two_Trailing_Spaces', 'SINone',
    'SpPhoneticAlphabetConverter', 'SpeechRegistryUserRoot',
    'DISPID_SGRsDynamic', 'SpeechPropertyResponseSpeed',
    'DISPID_SDKCreateKey'
]

_check_version('1.2.1', 1700254794.730704)
